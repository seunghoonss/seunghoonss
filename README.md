...
![image](https://github.com/seunghoonss/seunghoonss/assets/109809978/74defead-8750-4fa1-90e6-14d8f5d7b2b2)

https://docs.google.com/presentation/d/1KgARcBUkaaVl4nsEHrd7u-UEXYIuNa6V/edit?usp=sharing&ouid=114095829059167375136&rtpof=true&sd=true
...
### 역할
1. 데이터 분석을 통한 자사 제품화를 위한 알고리즘 연구
2. 데이터 시각화/리포팅 및 Insight 발굴 및 예측 모델 수립
3. DB 시스템 작업 후 개발 전 프로토타이핑 테스트
4. 실제 제품 릴리즈 후 사용자 반응 분석
5. 프로덕트의 리서치부터 기획, 디자인, 제품 구현까지 참여
   
### 기능
1. 의료폐기물에 대한 데이터(무게, 적재량)를 자사 웹 플랫폼에 전송하여, 전용용기의 적재량을 최대한으로 활용 가능함
2. 폐기물 데이터를 기반으로 의료기관에게 수거 주기 및 추이를 알려주고, 이에 대한 데이터를 수거/운반 업체에게 제공하여 불필요한 노동작업을 간소화 함
...
### 역할
1. 아이디어 도출 및 기획
2. Crowling 자료구성 및 데이터 구축
3. SQL쿼리를 통해 데이터 취합
4. EDA 탐색적 자료 및 데이터 분석
5. Python을 통해 데이터 전처리
6. 분석 알고리즘 및 방법론 구현
7. 최종 본선 발표
...
## 자동 제동장치를 탑재한 전동 유모차
- [ ]  2022 인공지능공학부 Capstone Design Project 'A+'
