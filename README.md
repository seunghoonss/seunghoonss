...
광진구 주정차 관련 현황을 파악하기 위해 약 1년간의 불법 주정차 관련 현장 민원 분석 및 주차장 확보 현황에 대해 분석하여, 광진구 주정차 문제를 해결하고 주민들의 삶의 질을 높이고자 다음과 같은 서비스를 제안함
...
1. 대표 팀장
2. 아이디어 도출 및 기획
4. Crowling 자료 구성 및 데이터 구축
5. Python을 통해 데이터 전처리
6. SQL 쿼리를 통해 데이터 취합
7. EDA 탐색적 자료 및 데이터 분석
8. Plotyexpress, Geopandas, Python 사이킷런 클러스터 라이브러리 활용
9. K-Means Clustering 알고리즘 모델 프로그래밍
10. Tableau 불법 주정차 현황 모니터링 대시보드 제작
11. 프로젝트의 오류 및 버그 디버깅 및 수정

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c3024eea-b4c1-4934-910c-9478445b887e/Untitled.png)
